...
const Servis = () => {
  return (
    <div className='servis min-vh-100 d-flex align-items-center' id='servis'>
        <Container>
            <Row className='mb-5'>
                <Col>
                    <h1 className='text-center fw-bold' data-aos='fade-up' data-aos-delay='200'>Servis</h1>
                    <p className='text-center' data-aos='fade-up'>Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
                </Col>
            </Row>
